  ...
  return (
    <div className="Footer">
      <div className="Footer__mission">
        <p tabIndex="0">
          <span className="light_blue">Our mission</span> is to know every
          student
        </p>
      ...
      >
        ...
        <FontAwesomeIcon className="Footer__icons-item" icon={faFacebookF} />
      ...
      <address className="Footer__address">
        ...
        <p tabIndex="0" className="address__City_State">
          Frisco, Texas 75035
        </p>
        <p className="address__Phone">
          <a href="tel:4696336000">
            <FontAwesomeIcon className="Footer__icons-address" icon={faPhone} />{" "}
            Phone 469.633.6000
          </a>
        </p>
        <p tabIndex="0" className="address__Fax">
          <FontAwesomeIcon className="Footer__icons-address" icon={faFax} /> Fax
          469.633.6050
        </p>
      </address>
      ...
      <div className="Footer__copyright">
        <p tabIndex="0" ariaLabel="Copyright Frisco Independent School">
          ©<span id="getDate">{fullYear} </span> Frisco Independent School
          District
        </p>
        <a
